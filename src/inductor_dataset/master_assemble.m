...
fprintf('assemble\n')
[diff, n_tot, n_sol, model_type, file_model, inp, out_fem] = dataset.get_assemble(folder_fem);

% compute the analytical results
fprintf('approx\n')
out_approx = dataset.get_out_approx(model_type, inp);
